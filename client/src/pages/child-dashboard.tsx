...
export default function ChildDashboardPage() {
  ...
  const { data: screenings, isLoading: isLoadingScreenings } = useQuery<ScreeningType[]>({
    queryKey: ["/api/screenings", { childId }],
    enabled: !!childId,
  });
  ...
  const isLoading = isLoadingChild || isLoadingScreenings || isLoadingUsers;
      ...
      <div className="p-4 container mx-auto max-w-5xl">
        <div className="flex items-start justify-between mb-6">
          <div>
            ...
            <p className="text-muted-foreground">ID: {child.childId}</p>
          </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{new Date(child.dateOfBirth).toLocaleDateString()} ({calculateAge(child.dateOfBirth)})</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{child.district}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{child.healthFacility}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{child.caretakerName}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{child.caretakerContact || "N/A"}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <Badge className={`${
                        child.status === "healthy" ? "bg-green-500 hover:bg-green-600" : 
                        child.status === "at-risk" ? "bg-amber-500 hover:bg-amber-600" : 
                        "bg-red-500 hover:bg-red-600"
                      }`}>
                        {child.status === "healthy" ? "Healthy" : 
                         child.status === "at-risk" ? "At Risk" : 
                         "Requires Attention"}
                      </Badge>
                    </div>
                  </div>
